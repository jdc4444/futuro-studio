...
export default function Home(){
 ...
 <Dialog><DialogTrigger className="futuro-information">information</DialogTrigger><DialogContent className="futuro-dialog"><DialogTitle>futuro</DialogTitle><DialogDescription>an independent creative studio based in brooklyn, new york.</DialogDescription></DialogContent></Dialog>
 <Dialog><DialogTrigger className="futuro-contact">contact</DialogTrigger><DialogContent className="futuro-dialog"><DialogTitle>contact</DialogTitle><DialogDescription>futuro llc · brooklyn, new york</DialogDescription></DialogContent></Dialog>
 <footer className="futuro-footer">FUTURO LLC © BROOKLYN NY MMXXVI</footer></>;
}
